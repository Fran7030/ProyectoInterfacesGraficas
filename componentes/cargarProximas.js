import Proximas from './claseProximas.js'

const apiProximasURL ='https://api.themoviedb.org/3/movie/upcoming?api_key=c8f0e89c2a789ea8a93c6db654ac65d8&language=es-CR&page=1'

var prox = new Proximas()

async function renderProx(){

    var htmlProximas = pelicula => `

    
        <div class="pelicula">
            <img data-lazy="https://image.tmdb.org/t/p/w300/${pelicula.poster_path}" src="" class="card-img-top" alt="${pelicula.title}">
            <div class="card-body BotonModal">
                <button type="button" class="btn btn-primary" data-bs-toggle="modal" data-bs-target="#exampleModal${pelicula.id}">
                    Detalles
                </button>
            </div>
                ...
                <div class="modal-dialog">
                    <div class="modal-content">
                        ...
                        <div class="modal-footer">
                            ...
                            <button type="button" class="btn btn-primary" onclick="guardar('${pelicula.id}','${pelicula.title}','https://image.tmdb.org/t/p/w500/${pelicula.poster_path}','${pelicula.overview}') " data-bs-dismiss="modal">Guardar</button>
                        </div>
                    </div>
                </div>
            </div>
    ...
    await prox.renderProximas(apiProximasURL, htmlProximas,'proximas')
}
await renderProx()
lazyLoading()